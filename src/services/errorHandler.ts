...
const errorHandler = (error: AxiosError): ErrorProps => {
    ...
    if (error.response) {
         ...
         */
        if (error.response.data as EmailError) {
            // console.table(error.response.data);

            errorMessage = (error.response.data as EmailError).message;
            // errorStatus = error.response.data.success;
        }
